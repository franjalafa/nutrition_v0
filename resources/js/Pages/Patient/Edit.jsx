...
export default function Create({ auth, patient }) {
    const { data, setData, post, errors, reset } = useForm({
        ...
        surname_father: patient.data.surname_father || "",
        surname_mother: patient.data.surname_mother || "",
    ...
    const onSubmit = (e) => {
        ...
        post(route("patient.update", patient.data.id));
    }
